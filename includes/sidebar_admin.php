...
<div class="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <a href="/admin/profile.php" class="<?= $current_page == 'profile.php' ? 'active' : '' ?>">
            <i class="fas fa-user"></i> <span>Profile</span>
        </a>
        <a href="/admin/items.php" class="<?= $current_page == 'items.php' ? 'active' : '' ?>">
        ...
        <a href="/admin/transactions.php" class="<?= $current_page == 'transactions.php' ? 'active' : '' ?>">
