                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="item_name" name="item_name" 
                               value="<?= htmlspecialchars($form_data['item_name'] ?? '') ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="base_item" name="base_item" 
                               value="<?= htmlspecialchars($form_data['base_item'] ?? '') ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="variant" name="variant" 
                               value="<?= htmlspecialchars($form_data['variant'] ?? '') ?>" 
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="3" 
                              placeholder="Optional description or notes about this item"><?= htmlspecialchars($form_data['description'] ?? '') ?></textarea>
